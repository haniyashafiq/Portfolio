  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <motion.h2
          className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-12 text-gray-900 dark:text-white"
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            focused on mastering modern web technologies like React, Node.js, and various
            databases while contributing to real-world projects.
          </p>
